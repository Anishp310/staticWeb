...
import g1 from "../assets/collabrate/g1.jpg";
import g2 from "../assets/collabrate/g2.jpg";
import g3 from "../assets/collabrate/g1.jpg";
import g4 from "../assets/collabrate/g2.jpg";
import g5 from "../assets/collabrate/g1.jpg";
import g6 from "../assets/collabrate/g2.jpg";
          ...
          {[...Array(imagesPerPage)].map((_, index) => {
            ...
            return (
              ...
              >
                <img
                  src={images[imgIndex]}
                  alt={`Collabrate Image ${imgIndex + 1}`}
                  className='w-auto h-full object-cover transform transition duration-500 hover:scale-110 rounded-lg'
                />
              </div>
            );
          })}
